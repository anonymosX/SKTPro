...
wp widget add custom_html header-1 --content="🔥 Need some items before your holidays? — Save 5% on all products with the code 'summer5off" --path=/home/$DOMAIN/public_html
